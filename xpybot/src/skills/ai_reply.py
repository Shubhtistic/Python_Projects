...
class AI_Reply:
    ...
    def perform_replies(self):
        ...
        for mention in mentions_list:
            ...
            print(f"replying to {mentioner_username} using AI ...")

            ai_reply_text = self._ai_client.ai_reply(mention_text)

            if not ai_reply_text:
                print(f"AI failed to generate reply for tweet {mention_tweet_id}")
                continue
